...
class Snake:
    ...
    def check_collision(self):
        if (
            self.rect.left < 0 or self.rect.right > WINDOW or
            self.rect.top < 0 or self.rect.bottom > WINDOW or
            self.rect.collidelist(self.segments[:-1]) != -1
        ):
            return True
        return False
