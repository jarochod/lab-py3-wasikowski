...
HIGHSCORE_FILE = os.path.join(FILES_DIR, "highscore.txt")
EAT_FILE = os.path.join(FILES_DIR, "eat.mp3")
GAMEOVER_FILE= os.path.join(FILES_DIR, "gameover.mp3")
...
class Game:
    def __init__(self):
        ...
        # Dźwięki
        self.eat_sound = self.load_sound(EAT_FILE)
        self.gameover_sound = self.load_sound(GAMEOVER_FILE)
