# R44. Operatory logiczne - ćwiczenia
...
if taskCompleted == True and linesOfCodeWritten >= 50: # True
    print("Go home")

hourOfDay = 15
if taskCompleted == True and linesOfCodeWritten >= 60 and hourOfDay >= 15: # True
    print("Go home")
...
if 10 > 5 or "Ania" != "Ola": # True
    print("true or true")

if 3 == 5 or "Ania" == "Ola": # False
