# R38. Operatory arytmetyczne - rezultat inwestycji wobec inflacji - zadanie
...
print("Zwrot z inwestycji:", earnedMoney)

lostMoney = capital * inflationRate
print("Spadek wartości kapitału z uwagi na inflację:", lostMoney)

newCapital = capital + earnedMoney - lostMoney
print("Zaktualizowany kapitał (po uwzględnieiniu inwestycji i inflacji):", newCapital)
