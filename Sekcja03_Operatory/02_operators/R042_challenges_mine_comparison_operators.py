# R42. Operatory porównania - zadanie
...
if 50 != 20: # True
    print("50 nie jest równe 20") # 50 nie jest równe 20

if "hello" != "goodby": # True
    print("String \'hello\' jest różny od \'goodbye\'") # String 'hello' jest różny od 'goodbye'
