...
print("current working directory: os.getcwd(): ", os.getcwd()) # current working directory: os.getcwd():  D:\Projekty\Projekty_VSC\Python\Python_PL_KW_
...
# print(os.listdir("../Python_PL_KW"))  # katalog wyżej + Python_PL_KW
...
print()
files = os.listdir("./Sekcja12_Praca_z_plikami/basics/06_files")
print(files)
