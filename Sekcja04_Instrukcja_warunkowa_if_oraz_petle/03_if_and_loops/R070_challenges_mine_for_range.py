...
for n in range(201):
    sum += n
print("Suma sekwencji liczb od 0 do 200:", sum)


sum = 0
for n in range(50, 101):
    sum += n
print("Suma sekwencji liczb od 500 do 100:", sum)

sum = 0
for n in range(0, 301, 3):
    sum += n
print("Suma sekwencji liczb od 0 do 300, z krokiem co 3:", sum)
