...
if number_of_elements > 0:
    ...
    while i > 0: # pobranie danych
        num = float(input(f"Podaj liczbę nr {number_of_elements-i+1}: "))
        i -=1
        sum += num

    avg = sum / number_of_elements # obliczenie średniej
    print("Obliczona średnia:", avg)
    
else: print("Nie można obliczyć średniej z 0 elementów")



# kod przygotowany przez instruktora
number_of_elements = int(input("Podaj liczbę elementów:"))
