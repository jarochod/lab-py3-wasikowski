# R58. Instrukcja if elif else - wiek psa - zadanie
...
if dog_age > 0:
    ...
    print("Obliczony wiek psa w ludzkich latach:", human_age)
else:
    print("Podano niepraidłową wartość.")
...
###---Prosta modyfikacja eleminująca błąd instruktora---
dog_age = float(input("Podaj wiek psa:"))
