# R57. Instrukcja if - rekrutacja - zadanie
...
if experience >= 2:
    if "python" in languages and "java" in languages:
        if "b2b" == contractType or "employent" == contractType:
            print("Kandydat spełnia warunki do zatrudnienia.")
        else:
            print("Kandydat nie spełnia wymogu typu zatrudnienia:", contractType)
    else:
        print("Kandydat nie zna wymaganych języków programowania.")
else:
    print("Kandydat nie spełnia wymogu doświadczenia.")



print("---rozwiazanie z kursu---")
