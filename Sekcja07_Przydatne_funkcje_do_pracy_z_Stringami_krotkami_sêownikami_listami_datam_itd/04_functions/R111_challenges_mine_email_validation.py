# R111. Łańcuchy znaków - walidacja maila - zadanie
...
print(email1, validateEmail1(email1))

email2 = "karol@domena"
print(email2, validateEmail1(email2))

email3 = "user.com"
print(email3, validateEmail1(email3))

email4 = "asia.kowalska@user.com"
print(email4, validateEmail1(email4))
