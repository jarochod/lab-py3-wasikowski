# R92. Mutowalne argumenty - zadanie 1
...
employee = employee2 # zmiana employee do testów

promoteToManager(employee)
print("Dane użytkonika po propomocji:",employee) # {'name': 'Adam', 'email': 'adam@example.com', 'rank': 'manager', 'salary': 12000.0}
