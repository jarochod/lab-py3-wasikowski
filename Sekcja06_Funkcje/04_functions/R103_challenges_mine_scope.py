...
def withdrawFunds(amount):
    ...
    else: print("Niewystarczająca ilość środków na koncie.")
...
while True:
    action=input("Wybierz działanie: wpłać, wypłać, stan, koniec: ").lower()
    if action == "koniec":
        break
        ...
        amount = float(input("Podak kwotę wypłaty: "))
        withdrawFunds(amount)
    
    elif action == "stan":
        displayBalance()
    
    else: print("Nieznane działanie.")
