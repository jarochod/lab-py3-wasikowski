# R81. return - zwracanie słownika - zadanie 3
...
user1 = creatUser("Ola", "ola@example.com")
print(user1) # {'name': 'Ola', 'email': 'ola@example.com', 'telephone': None}

user2 = creatUser("Kasia", 987654321)
print(user2) # {'name': 'Kasia', 'email': None, 'telephone': 987654321}
